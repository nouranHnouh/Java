...
public class JavaAssign1Nouh0009 { 
	
	private String childToyNouh0009; //child toy 
	
	private String nounNouh0009; //  first noun
	
	private String adjNouh0009; //adjective 
	
	private String noun2Nouh0009; // second noun  
	...
	public void displayWord() {
		...
		System.out.println (" in " +placeNouh0009+ " she  "+verbNouh0009 + " and plays with her classmates. " +
	...
	public static void main(String [] args) {
		...
		//new object of class 
		JavaAssign1Nouh0009 madLib1=new JavaAssign1Nouh0009(); 
